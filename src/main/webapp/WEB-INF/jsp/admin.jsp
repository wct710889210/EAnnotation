	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="admin.jsp"><span>智能批注系统</span></a>
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="admin.jsp"><i class="icon-bar-chart"></i><span class="hidden-tablet"> 数据汇总</span></a></li>
						<li><a href="messages.html"><i class="icon-envelope"></i><span class="hidden-tablet"> 文章详细</span></a></li>
						<li><a href="tasks.html"><i class="icon-tasks"></i><span class="hidden-tablet"> 用户信息管理</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
				...
				<div class="sparkLineStats span4 widget green" onTablet="span5" onDesktop="span4">
                    ...
                    <ul class="unstyled">
                        ...
                        <li><span class="sparkLineStats6"></span>
                            小学年级段阅读量: <span class="number">4377</span>
                        </li>
                        <li><span class="sparkLineStats7"></span>
                            初中年级段阅读量: 
                            <span class="number">7993</span>
                        </li>
			...
			<div class="row-fluid">
				...
				<div class="widget blue span5" onTablet="span6" onDesktop="span5">
					...
					<h2><span class="glyphicons globe"><i></i></span> 用户阅读类型占比</h2>
				...
				<div class="widget yellow span4 noMargin" onTablet="span12" onDesktop="span4">
					<h2><span class="glyphicons fire"><i></i></span> 访问量监控</h2>
					<hr>
					<div class="content">
