...
<html>
  ...
  <body>
    ...
    <div id="app" class="framework7-root">
      ...
      <!-- 右侧侧边栏 -->
      <div class="panel panel-right panel-cover anpanel" id="anpanel">
        <div class="subnavbar subbar" id="searchnav">
          <!-- Searchbar with auto init -->
        ...
        <div class="block" id="Mynote">
          <div id="ancontent">
            <div class="card">
              <div class="card-header">教师</div>
              <div class="card-content card-content">
                <blockquote class="blockquote">
                  <p>阿里</p>
                </blockquote>
                <p id="anPnode">有了野心，你才能坚持不懈、不断学习和改进，以最快的速度完善自己！</p>
              </div>
              <div class="card">
                <div class="card-header">学生</div>
                <div class="card-content card-content">
                  <blockquote class="blockquote">
                    <p>巴巴</p>
                  </blockquote>
                  <p id="anPnode">你穷，是因为你缺乏变不可能为可能的勇气和巨大决心！</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="navbar">
          <div class="navbar-inner">
            ...
            <div class="title">可以失去一切，不能失去理想
              <div class="stitle">批注人：张宇宙老师，5 个批注
              </div>
            </div>
            <div class="right">
