    ...
    <body>
        ...
        <div id="app">
            ...
            <div class="view view-main">
                ...
                <!-- 头部标题栏 -->
                <div class="navbar">
                    <div class="navbar-inner" style="padding: 0 50px;">
                        <div class="left" style="font-size: 16px;">
                            悦批
                        </div>
                        <div class="title" style="margin-left: 500px;">
                            <div class="stitle" style="font-size: 16px;">
                                <div class="float" style="margin-left: 50px;">排行</div>
                                <div class="float" style="margin-left: 50px;">作业</div>
                                <div class="float" style="margin-left: 50px;">班级</div>
                                <div class="float" style="margin-left: 50px;">首页</div>
                            </div>
                        </div>

                        <div class="right" style="font-size:16px;margin-right:10px;">
                            <i class="f7-icons" style="font-size:20px;">person_fill</i>
                            &nbsp;&nbsp; 个人中心
                        </div>
                    </div>
                </div>
                ...
                <div class="page-content" style="padding-top:45px;">
                    <!-- <div class="list media-list annotator" style="padding:0 100px">
                    <ul>
                        <li>
                            <a href="#" class="item-link item-content class">
                                ...
                                <div class="item-inner">
                                    <div class="item-title">
                                        <div class="item-title" style="font-size:12px;">发布人：张晓飞老师</div>
                                    </div>
                                    <div class="item-subtitle" style="font-size:12px;">教育工作者</div>
                                </div>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div style="text-align:center;margin-top: 20px;font-size: 30px;">
                        <strong>可以失去一切，不能失去理想</strong>
                    </div>
                    <div id="txblock">
                        <div class="block" id="box" style="color:black;padding:0 100px;">
