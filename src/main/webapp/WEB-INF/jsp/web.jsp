        ...
        <div class="view view-main">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="right" style="font-size:10px;margin-right:10px;">
                        <i class="f7-icons" style="font-size:15px;">person_fill</i>
                       &nbsp; 个人中心
                    </div>
                </div>
            </div>
            ...
            <div class="page-content" style="padding-top:45px;">
                            ...
                            <a href="#" class="item-link item-content class">
                                ...
                                <div class="item-inner">
                                    <div class="item-title">
                                        <div class="item-title" style="font-size:10px;">发布人：张晓飞老师</div>
                                    </div>
                                    <div class="item-subtitle" style="font-size:10px;">教育工作者</div>
                                </div>
                            </a>
                        </li>
                    </ul>
                ...
                <div id="txblock">
                    <div class="block" id="box" style="color:black;padding:0 40px;">
