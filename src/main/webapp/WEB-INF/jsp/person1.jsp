      ...
      <div class="view view-main view-init">
        ...
        <div class="toolbar tabbar-labels">
          <div class="toolbar-inner">
            <a href="stindex.html" class="tab-link an-button link external">
        ...
        <div class="page-content">
              ...
              <li>
                <a href="#" class="item-link item-content login-screen-open" data-login-screen=".login-screen">
                  <div class="item-media">
                    <img class="radius" src="images/login.jpg" width="80" />
                  </div>
                  <div class="item-inner">
                    <div class="item-title-row">
                      <div class="item-title">胡一天</div>
                    </div>
                    <div class="item-subtitle">
                      <p> </p>
                    </div>
                    <div class="item-text">hyt@foxmail.com</div>
                  </div>
                </a>
              </li>
            </ul>
            ...
            <ul>
              <li>
                <a href="#" class="item-link item-content">
                  ...
                  <div class="item-inner">
                    <div class="item-title">我批注过的文章</div>
                  </div>
                </a>
              </li>
            </ul>
          ...
          <div class="list">
            <ul>
              ...
              <li>
                <a href="person.html" class="item-link item-content">
                  <div class="item-media">
            ...
            <div class="view">
              <div class="page">
                <div class="page-content login-screen-content">
                  <div class="logo text-center"><img src="images/logo.png" width="75px"></div>
                  ...
                  <form>
                    ...
                    <div class="block">
                      <p class="row">
                        <button class="col-85 button button-big button-fill" style="margin-left: auto;margin-right: auto;"><a href="person2.html" class="icon">登录</a></button>
                      </p>
                      <p class="row">
                        <button class="col-85 button button-big button-fill popup-open" style="margin-left: auto;margin-right: auto; background: #0b5670"
                          data-popup=".popup-about">注册</button>
                      </p>
                    </div>
                    <div class="text-center"><a class="link login-screen-close" href="#">取消</a></div>
                  </form>
                </div>
              </div>
            </div>
          ...
          <div class="popup popup-about">
            <div class="page-content login-screen-content">
              ...
              <form>
                ...
                <div class="block">
                  <p class="row">
                    <button class="col-85 button button-big button-fill popup-open" style="margin-left: auto;margin-right: auto;" data-popup=".popup-chose">下一步</button>
                  </p>
                </div>
                <div class="text-center"><a class="link popup-close login-screen-close" href="#">取消</a></div>
              </form>
            </div>
          </div>
          ...
          <div class="popup popup-chose">
            <div class="page-content login-screen-content">
              ...
              <form>
                ...
                <div class="block">
                  <p class="row">
                    <button class="col-85 button button-big button-fill" style="margin-left: auto;margin-right: auto;"><a href="person1.html">完成</a></button>
                  </p>
                </div>
                <div class="text-center"><a class="link popup-close login-screen-close" href="#">暂时跳过</a></div>
              </form>
            </div>
          </div>
        </div>
