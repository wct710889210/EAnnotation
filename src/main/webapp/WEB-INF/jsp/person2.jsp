      ...
      <div class="view view-main view-init">
        ...
        <div class="toolbar tabbar-labels">
          <div class="toolbar-inner">
            <a href="stindex2.html" class="tab-link an-button link external">
              ...
              <li>
                <a href="#" class="item-link item-content login-screen-open" data-login-screen=".login-screen">
                  <div class="item-media">
                    <img class="radius" src="images/lw.jpg" width="80" />
                  </div>
                  <div class="item-inner">
                    ...
                    <div class="item-text">lw@foxmail.coom</div>
                  </div>
                </a>
              </li>
            </ul>
          ...
          <div class="popup popup-chose">
            <div class="page-content login-screen-content">
              ...
              <form>
                ...
                <div class="block">
                  <p class="row">
                    <button class="col-85 button button-big button-fill" style="margin-left: auto;margin-right: auto;"><a href="person1.html" class="icon">完成</a></button>
                  </p>
                </div>
