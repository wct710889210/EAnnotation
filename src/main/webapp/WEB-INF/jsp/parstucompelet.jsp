        ...
        <div class="block" id="Mynote" style="margin-top: 0;">
          <div id="ancontent">
            ...
            <div class="card cardcss" id="teacher">
              <blockquote class="blockquote bqcolor2">
                <p>今天的阿里巴巴已经不是一家普通的公司，已经是一个经济体</p>
              </blockquote>
              <div class="card-content cardct">
                <p id="anPnode">阿里已经和我们的国家经济个人生活紧密的联系在一起</p>
              </div>
            ...
            <div class="card cardcss" id="student">
              <blockquote class="blockquote bqcolor1">
                <p>以前的经济体以地理位置界定：长三角经济体，珠三角经济体，加州经济体但是今天新的经济体诞生在互联网上</p>
              </blockquote>
              <div class="card-content cardct">
                <p id="anPnode">互联网已经是一个新经济体诞生地</p>
              </div>
              <div class="card-footer">
                <a href="#" class="link">
            ...
            <div class="card cardcss" id="teacher">
              <blockquote class="blockquote bqcolor0">
                <p>我们希望能够让更多的发展中国家，中小企业和年轻人都能够分享自由贸易和全球化的快乐</p>
              </blockquote>
              <div class="card-content cardct">
                <p id="anPnode">届时不只是中国人能享受到网上购物的便利</p>
              </div>
              <div class="card-footer">
                <a href="#" class="link">
            ...
            <div class="card cardcss" id="teacher">
              <blockquote class="blockquote bqcolor3">
                <p>一个新型的经济体以前的经济体以地理位置界定：长三角经济体，珠三角经济体，加州经济体但是今天新的经济体诞生在互联网上</p>
              </blockquote>
              <div class="card-content cardct">
                <p id="anPnode">今后更多的经济体都将诞生在互联网上而不是地理位置</p>
              </div>
              <div class="card-footer">
                <a href="#" class="link">
            ...
            <div class="card cardcss" id="teacher">
              ...
              <div class="card-content cardct">
                <p id="anPnode">以后我们在家中就能通过淘宝直接购买到世界各地商家的商品</p>
              </div>
              <div class="card-footer">
                <a href="#" class="link">
            ...
            <div class="card cardcss" id="teacher">
              <blockquote class="blockquote bqcolor4">
                <p>中小企业和年轻人都能够分享自由贸易和全球化的快乐，尝试创业创新的快乐，享受技术进步的好处</p>
              </blockquote>
              <div class="card-content cardct">
                <p id="anPnode">互联网将带给我们跟多的创业就业机会</p>
              </div>
              <div class="card-footer">
                <a href="#" class="link">
